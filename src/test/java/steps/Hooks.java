...
public class Hooks extends CommonMethods {
    ...
    public void end(Scenario scenario){
        byte[] pic;
        //here we can take screenshot before closing the browser
        //Scenario class in cucumber which will give me the information of the execution.
        // It holds complete information of the execution
